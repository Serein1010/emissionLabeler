...
from utils.ComputeProcessorType import COMPUTE_PROCESSOR_TYPES, broadwellSkylake, broadwelCascadeLake, skyLakeBroadwellHaswellAMDRome,skyLakeBroadwellHaswellSandyBridgeIvyBridge
class SHARED_CORE_PROCESSORS(Enum):
    E2_MICRO = 'e2-micro'
    E2_SMALL = 'e2-small'
    E2_MEDIUM = 'e2-medium'
    F1_MICRO = 'f1-micro'
